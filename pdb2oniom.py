...
%mem={mem}
%nprocshared={nproc}
#p opt=(quadmac, calcfc, maxstep=10) oniom(b3lyp/6-31+g(d,p):amber=softonly)
scf=qc geom=connectivity nosymm iop(2/15=3)
...
def writecoordinatesinfo(resid, near, parm) -> str:
...
def writegjffile(
    ...
    logging.info(
        "pdb2oniom.py ver.0.1; Amber parm and rst7 files to Gaussian ONIOM input file."
    )
    ...
    desc += writecoordinatesinfo(resid, near, parm)
